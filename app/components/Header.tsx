      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <Link href="/" className="-m-1.5 p-1.5">
            <span className="sr-only">PodMagic Media</span>
            <div className="flex items-center space-x-3">
              ...
              {/* Logo Text */}
              <div>
                <h1 className="text-2xl font-bold text-brand-black">PodMagic</h1>
                <p className="text-xs text-brand-gray -mt-1">Media</p>
              </div>
            </div>
          </Link>
        </div>
            ...
            <div className="flex items-center justify-between">
              <Link href="/" className="-m-1.5 p-1.5">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h1 className="text-lg font-bold text-brand-black">PodMagic</h1>
                    <p className="text-xs text-brand-gray -mt-1">Media</p>
                  </div>
                </div>
              </Link>
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                ...
                <div className="py-6">
                  <Link
                    href="/contact"
                    className="block w-full bg-brand-yellow hover:bg-yellow-400 text-brand-black font-semibold py-3 px-6 rounded-full text-center transition-colors duration-200"
                    onClick={() => setMobileMenuOpen(false)}
                  >
                    Get Started
                  </Link>
